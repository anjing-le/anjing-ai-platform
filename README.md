...
| `gateway` | `gateway-api` | `/api/gateway/routes`, `/api/gateway/routes/health-check`, `/api/gateway/model-routes`, `/api/gateway/llm/invoke`, `/api/gateway/llm/stream`, `/api/gateway/request-logs`, `/api/gateway/request-logs/export`, `/api/gateway/request-logs/retention/purge` |
